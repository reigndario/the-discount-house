...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col px-4 py-6 sm:px-10 sm:py-8">
      {/* items-baseline puts the image's bottom edge on the text baseline; the negative margin
          cancels the tracking's trailing space after the final E so the mark sits right beside it. */}
      <p className="flex items-baseline text-sm font-medium uppercase tracking-[0.3em]">
        ...
        <Image src="/tdh-logo.png" alt="" width={24} height={24} priority className="ml-2 h-6 w-6" />
      </p>
