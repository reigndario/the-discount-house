...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col px-4 py-6 sm:px-10 sm:py-8">
      {/* Logo centred over the wordmark. The negative margin cancels the tracking's trailing space
          after the final E, so centring is measured against the visible letters. */}
