...
export default function DocsPage() {
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-xs font-semibold uppercase tracking-wide bg-tdh-black text-tdh-cream inline-block px-3 py-2 mb-12">
        Coming soon
      </p>
      ...
      <p className="text-tdh-black/70 mb-10 max-w-2xl">
        ...
        {differentiators.map((d) => (
          <div key={d.title} className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-tdh-black/70">{d.body}</p>
            </div>
          </div>
        ))}
      </div>

      <p className="text-xs uppercase tracking-wide text-tdh-black/50">
